...
export type Permissions<T extends PermissionsTree> = T[keyof T] extends infer V
  ? V extends string
    ? V
...
export type RolePermissions<R extends string = string, P extends string = string> = Readonly<
  Record<R, readonly PermissionOrWildcard<P>[]>
>
